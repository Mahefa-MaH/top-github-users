...
The `number of followers` of users in Poland on `2024/4/28 12:40 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
