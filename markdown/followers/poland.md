...
The `number of followers` of users in Poland on `2024/11/22 2:22 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
