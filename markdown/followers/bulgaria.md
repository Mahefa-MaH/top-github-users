...
The `number of followers` of users in Bulgaria on `2025/3/18 2:21 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
