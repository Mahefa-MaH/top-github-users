...
The `number of followers` of users in Pakistan on `2024/4/25 12:37 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
