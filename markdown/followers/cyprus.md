...
The `number of followers` of users in Cyprus on `2024/10/20 2:21 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
