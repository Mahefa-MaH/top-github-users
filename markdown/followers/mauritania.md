...
The `number of followers` of users in Mauritania on `2024/6/25 12:31 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
