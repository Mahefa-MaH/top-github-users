...
The `number of followers` of users in Mozambique  on `2025/1/22 2:11 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
