...
The `number of followers` of users in Brazil on `2025/3/18 12:50 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.
...
<table>
	...
	<tr>
		...
		<td>Working From Home And<br/>Prohibited<br/>By<br/>Employment<br/>Contract.<br/>🔓<br/></td>
		<td>No Twitter Username</td>
		<td>São Paulo - Brasil</td>
		<td>447</td>
	</tr>
