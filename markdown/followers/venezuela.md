...
The `number of followers` of users in Venezuela on `2024/7/23 1:53 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
