...
The `number of followers` of users in Slovenia on `2024/7/13 12:39 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
