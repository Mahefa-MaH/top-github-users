...
The `number of followers` of users in Jordan on `2025/4/9 12:47 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
