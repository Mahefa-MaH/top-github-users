...
The `number of followers` of users in South Korea on `2024/5/5 1:48 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
