...
The `number of followers` of users in Azerbaijan on `2024/10/7 2:17 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
