...
The `number of followers` of users in Finland on `2025/1/2 2:13 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
