...
The `number of followers` of users in United Arab Emirates on `2024/12/6 2:16 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
