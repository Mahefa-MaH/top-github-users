...
The `number of followers` of users in Botswana on `2024/3/17 1:39 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
