...
The `number of followers` of users in Botswana on `2025/3/17 2:25 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
