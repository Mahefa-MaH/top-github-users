...
The `public contributions` and `private contributions` by users in Taiwan on `2024/6/1 12:40 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
