...
The `public contributions` and `private contributions` by users in Georgia on `2025/1/3 2:14 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
