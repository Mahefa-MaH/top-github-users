...
The `public contributions` and `private contributions` by users in Norway on `2024/11/18 2:27 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
