...
The `public contributions` and `private contributions` by users in Iraq on `2025/4/6 12:50 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
