...
The `public contributions` and `private contributions` by users in Mali on `2024/4/15 2:57 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
