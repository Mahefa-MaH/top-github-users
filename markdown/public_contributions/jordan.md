...
The `public contributions` by users in Jordan on `2024/4/9 12:34 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
